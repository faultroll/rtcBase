...
class RTC_EXPORT SequenceCheckerImpl {
 ...
 private:
  ...
  mutable Thrd valid_thread_ RTC_GUARDED_BY(lock_);
...
class RTC_SCOPED_LOCKABLE SequenceCheckerScope {
 ...
 private:
  RTC_DISALLOW_COPY_AND_ASSIGN(SequenceCheckerScope);
};
}  // namespace internal
}  // namespace rtc
...
#define RTC_DCHECK_RUN_ON(x)                                              \
  rtc::internal::SequenceCheckerScope seq_check_scope(x); \
  RTC_DCHECK(rtc::internal::SequenceCheckerScope::IsCurrent(x))
