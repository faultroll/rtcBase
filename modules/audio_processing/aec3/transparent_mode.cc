...
bool DeactivateTransparentMode() {
  return true/* field_trial::IsEnabled("WebRTC-Aec3TransparentModeKillSwitch") */;
}

bool DeactivateTransparentModeHmm() {
  return true/* field_trial::IsEnabled("WebRTC-Aec3TransparentModeHmmKillSwitch") */;
}
...
std::unique_ptr<TransparentMode> TransparentMode::Create(
  ...
  if (DeactivateTransparentModeHmm()) {
    return std::unique_ptr<LegacyTransparentModeImpl>(
        new LegacyTransparentModeImpl(
            config));
  }
  return std::unique_ptr<TransparentModeImpl>(
      new TransparentModeImpl(
          ));
}
