...
bool DeactivateInitialStateResetAtEchoPathChange() {
  return true/* field_trial::IsEnabled(
      "WebRTC-Aec3DeactivateInitialStateResetKillSwitch") */;
}

bool FullResetAtEchoPathChange() {
  return !true/* field_trial::IsEnabled("WebRTC-Aec3AecStateFullResetKillSwitch") */;
}
...
rtc::Optional<float> AecState::ErleUncertainty() const {
  if (SaturatedEcho()) {
    return 1.f;
  }
