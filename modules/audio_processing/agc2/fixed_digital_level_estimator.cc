...
void FixedDigitalLevelEstimator::SetSampleRate(size_t sample_rate_hz) {
  samples_in_frame_ = /* rtc::CheckedDivExact */RTC_CHECK_DIV_EXACT(sample_rate_hz * kFrameDurationMs,
                                           static_cast<size_t>(1000));
  samples_in_sub_frame_ =
      /* rtc::CheckedDivExact */RTC_CHECK_DIV_EXACT(samples_in_frame_, kSubFramesInFrame);
  CheckParameterCombination();
}
